...
function pullMembers(adminEmail, selectedRoom){

    wait(700).then(()=>{
        ax(adminEmail);
        wait(700).then(()=>{
            axx(selectRoom(adminEmail));
            wait(700).then(()=>{
                axxx();
            });
        });
    ...
    async function axx(selectedRoom){
        //this function gets the doc.data();
        await getting(whereIds[selectRoom(adminEmail)]);
        console.log('whereIds', whereIds);
        wait(700).then(()=>{
            if(evenArr2==undefined){
                two();
    ...
    function axxx(){
        var members = evenArr2[selectedRoom].memberList;
