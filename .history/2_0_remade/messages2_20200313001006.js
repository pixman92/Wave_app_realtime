...
async function two(etc, memberEmail){
    // whereIds=[];
    await whereMe('chatrooms3/' + where[0] + '/messagesData/', 'memberEmail', memberEmail, async()=>{
...
async function three(){
    ...
    rootStr = 'chatrooms3/' + where[0] + '/messagesData/';
    console.log('rootStr', rootStr);
    await getting(rootStr.toString(), where[1], async()=>{
        // rootStr =  + whereIds[1];
        // setTimeout(() => {
        //     return true;
        // }, 5000);
